...
public extension UITextView {
    public func calculateSize(for width: CGFloat, numberOfLines: Int?, exclusionPaths: [UIBezierPath] = []) -> CGSize {
    ...
    public func calculateContentOffset(for maxHeight: CGFloat) -> CGFloat? {

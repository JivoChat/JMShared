...
public protocol IDatabaseDriver: class {    
    ...
    func reference<OT: Object>(to object: OT) -> ModelRef<OT>
...
open class DatabaseDriver: IDatabaseDriver {
    ...
    public func reference<OT: Object>(to object: OT) -> ModelRef<OT> {
        return ModelRef(databaseDriver: self, value: object)
    }
